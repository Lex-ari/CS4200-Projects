...
class Chessboard(tk.Tk):
    ...
    def search_next_move(self):
        ...
        while self.current_row >= 0 and self.current_row < 8:
            ...
            if col >= 8:
                ...
                if self.queens_positions:
                    ...
                    self.highlight_row(self.current_row)  # Highlight the backtracked row
                return  # Stop to show the backtracking step
            ...
            if self.is_safe(self.current_row, col):
                ...
                return  # Stop after placing one queen
