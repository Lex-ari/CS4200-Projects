...
class Chessboard(tk.Tk):
    def __init__(self):
        ...
        self.is_backtracking = False  # To track if the algorithm is backtracking
    ...
    def place_next_queen(self):
        ...
        self.after(500, self.search_next_move)  # Use a delay to visualize each step
    ...
    def search_next_move(self):
        ...
        # Move to the next column to try
        ...
        if col >= 8:
            ...
            if self.queens_positions:
                ...
                self.after(500, self.place_next_queen)  # Wait before continuing backtracking
            return
        ...
        if self.is_safe(self.current_row, col):
            ...
            if self.current_row == 8:
                ...
                self.after(500, self.place_next_queen)  # Continue to the next row after placing the queen
        else:
            # If this column isn't safe, keep looking in the current row
            self.after(500, self.place_next_queen)  # Delay to continue searching in the current row
